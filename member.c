...
void displayMember() {
	...
	printf("\t\t\t __  __ _____ __  __ ____  _____ ____      ___ _   _ _____ ___  __  __ ____      _  _____ ___ ___  _   _ \n");
	printf("\t\t\t|  \\/  | ____|  \\/  | __ )| ____|  _ \\    |_ _| \\ | |  ___/ _ \\|  \\/  |  _ \\    / \\|_   _|_ _/ _ \\| \\ | | \n");
	printf("\t\t\t| |\\/| |  _| | |\\/| |  _ \\|  _| | |_) |    | ||  \\| | |_ | | | | |\\/| | |_) |  / _ \\ | |  | | | | |  \\| | \n");
	printf("\t\t\t| |  | | |___| |  | | |_) | |___|  _ <     | || |\\  |  _|| |_| | |  | |  _ <  / ___ \\| |  | | |_| | |\\  | \n");
	printf("\t\t\t|_|  |_|_____|_|  |_|____/|_____|_| \\_\\   |___|_| \\_|_|   \\___/|_|  |_|_| \\_\\/_/   \\_\\_| |___\\___/|_| \\_| \n");
	printf("\t\t\t---------------------------------------------------------------------------------------------------------\n");
...
int deleteMember() {
	...
	if (numMember > 0) {
		...
		} while (again == 2 || strcmp(deleteFunct, "0")!=0);
...
void displayFeedback() {
	...
	if (feedbackNum > 0) {
		...
		printf("\t\t\t\t\t\t ______ ______ ______ ____   ____     _     _____ _  __\n");
		printf("\t\t\t\t\t\t|  ___|| ____|| ____||  _ \\ | __ )   / \\   / ___|| |/ /\n");
		printf("\t\t\t\t\t\t| |_   |  _|  |  _|  | | | ||  _ \\  / _ \\ | |    | ' / \n");
		printf("\t\t\t\t\t\t|  _|  | |____| |____| |_| || |_) |/ ___ \\\\ |____| . \\ \n");
		printf("\t\t\t\t\t\t|_|    |_____||_____||____/ |____//_/   \\_\\\\____||_|\\_\\ \n");
		printf("\t\t\t\t\t\t-------------------------------------------------------\n");
