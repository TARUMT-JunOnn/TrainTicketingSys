...
main() {
    ...
    //printf("New account ID added today\n");
...
//manager modify particular staff / entire staff schedule 
void modifyEmpRestSchedule(struct Staff* staff, struct Manager* manager)
{
    char id[MAX_ID_LENGTH];
    int ans = 0;
...
void updateManager_information(struct Staff* staff, struct Manager* manager, int managerNum) {
    ...
    do {
        ...
        printf("---------------------------------------------------\n");
        printf("%-20s%-20s%-20s\n","Name","Phone No", "Email");
        printf("%-20s%-20s%-20s\n", manager[managerNum].table.name, manager[managerNum].table.phone, manager[managerNum].table.email);
        printf("---------------------------------------------------\n");
        printf("\nConfirm to update?(Y/N): ");
        scanf(" %c", &confirm);
        ...
        if (confirm == 'Y' || confirm == 'y') {
            ...
            printf("%-20s%-20s%-20s\n", manager[managerNum].table.id, manager[managerNum].table.name, manager[managerNum].table.phone, manager[managerNum].table.email);
            printf("\n--------------------------------------------------\n");
            system("pause");
        }
        else
...
void security_Ques()
{
    title();
    printf("\n------------- Security Question -------------\n");
    printf("     Choose two security questions below      \n");
    printf("      -----------------------------------      \n");
